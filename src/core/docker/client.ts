...
import { DockerNotRunningError, DockerVersionError, DockerError } from '../errors.js';
...
export class DockerClient {
  ...
  async exec(
    ...
    return new Promise((resolve, reject) => {
      ...
      const stdoutStream = { write: (chunk: Buffer) => { stdoutChunks.push(chunk); return true; } };
      const stderrStream = { write: (chunk: Buffer) => { stderrChunks.push(chunk); return true; } };
