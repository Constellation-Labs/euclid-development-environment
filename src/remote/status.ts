import { fetchNodeInfo } from '../core/cluster/health.js';
import type { NodeInfo } from '../core/cluster/health.js';
import type { EuclidConfig, DeployConfig } from '../core/config/schema.js';
...
export async function remoteStatus(config: EuclidConfig): Promise<RemoteNodeStatus[]> {
  ...
  const results: RemoteNodeStatus[] = [];
